...
image:menu-highlight.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/menu-highlight.png"]
...
* Menu itens search +
image:menu-search.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/menu-search.png"]
...
admin.renderFormAsterisks=false <31>
admin.closableLoading=true <32>
admin.enableMobileHeader=true <33>
...
<6> When false ajaxStatus, which triggers the loading bar on every ajax request, will not be rendered. Can also be disabled per page using `<ui:param name="renderAjaxStatus" value="false"`.
...
<31> Render asterisks on p:outputLabels tied to required fields. Can be enabled on specific pages using `<ui:param name="renderFormAsterisks" value="true"`.
<32> Makes ajax loading dialog closable. 
<33> Adds active menu (icon and text) to navbar on small devices. Can also be disabled per page using `<ui:param name="enableMobileHeader" value="false"`.
...
image::500.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/500.png"]
...
image::403.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/403.png"]
...
image::404.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/404.png"]
...
image::expired.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/expired.png"]
...
image::optimistic.png[height="350" width="400" link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/optimistic.png"]
...
[.text-center]
image::controlsidebar.png[height="300" width=400, link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/controlsidebar.png"]
...
[.text-center]
image::breadcrumbs.png[height="400" width=100% link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/breadcrumbs.png"]
...
+
image:car-form-bread.png[width=100%, height=300, link="https://raw.githubusercontent.com/adminfaces/docs/master/src/docs/images/car-form-bread.png"]
+
