...
:link-admin-showcase-openshift: http://admin-showcase-admin.1d35.starter-us-east-1.openshiftapps.com/showcase
:link-admin-starter-openshift: http://admin-starter-admin.1d35.starter-us-east-1.openshiftapps.com//admin-starter/
