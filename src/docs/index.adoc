...
icon:file-pdf-o[] Read this documentation {link-admin-docs}/latest/index.pdf[in PDF here, role="external", window="_blank"].
endif::[]

ifeval::["{backend}" == "pdf"]
icon:html5[] Read this documentation {link-admin-docs}/latest/[in HTML5 here, role="external", window="_blank"].
endif::[]
