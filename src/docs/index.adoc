...
icon:file-pdf-o[] Read this documentation {link-admin-site}/latest/index.pdf[in PDF here, role="external", window="_blank"].
endif::[]

ifeval::["{backend}" == "pdf"]
icon:html5[] Read this documentation {link-admin-site}/latest/[in HTML5 here, role="external", window="_blank"].
endif::[]
